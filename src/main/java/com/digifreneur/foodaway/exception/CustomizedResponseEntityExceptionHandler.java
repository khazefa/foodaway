...
import com.digifreneur.foodaway.dto.response.Response;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(FoodawayException.EntityNotFoundException.class)
    ...
    @ExceptionHandler(FoodawayException.DuplicateEntityException.class)
